...
def plot_AUC(graphic_datas, n):
    """
    plots an AUC graph for a number of classifier
    :param graphic_datas: dictionary generated by training.tenfold function with the name of the classifier as key and a list of values to plot [mean_tpr, mean_fpr, tprs_lower, tprs_upper, mean_auc, std_auc] as value.
